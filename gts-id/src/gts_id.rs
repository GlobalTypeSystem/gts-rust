...
//! test an ID against a [`GtsIdWildcard`] pattern.

use std::fmt;
use std::str::FromStr;

use crate::parse::parse_gts_id;
use crate::{GTS_PREFIX, GtsIdError, GtsIdSegment, GtsIdWildcard};
...
impl GtsId {
    ...
    /// identifier. Parse wildcard patterns with [`GtsIdWildcard::new`] instead.
    ///
    /// # Errors
    ...
    #[must_use]
    pub fn wildcard_match(&self, pattern: &GtsIdWildcard) -> bool {
